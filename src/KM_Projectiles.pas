...
type
  ...
  private
    ...
    function AddItem(const aStart,aAim,aEnd: TKMPointF; aSpeed, aArc, aMaxLength: Single; aProjType: TProjectileType; aOwner: TKMUnit):word;
    procedure RemItem(aIndex: Integer);
    function ProjectileVisible(aIndex: Integer): Boolean;
  public
    constructor Create;
    function AimTarget(const aStart: TKMPointF; aTarget: TKMUnit; aProjType: TProjectileType; aOwner: TKMUnit; aMaxRange,aMinRange: Single):word; overload;
    function AimTarget(const aStart: TKMPointF; aTarget: TKMHouse; aProjType: TProjectileType; aOwner: TKMUnit; aMaxRange,aMinRange: Single):word; overload;
...
function TKMProjectiles.AimTarget(const aStart: TKMPointF; aTarget: TKMUnit; aProjType: TProjectileType; aOwner: TKMUnit; aMaxRange,aMinRange: Single): Word;
var
...
function TKMProjectiles.AimTarget(const aStart: TKMPointF; aTarget: TKMHouse; aProjType: TProjectileType; aOwner: TKMUnit; aMaxRange,aMinRange: Single): Word;
var
  Speed, Arc: Single;
...
function TKMProjectiles.AddItem(const aStart,aAim,aEnd: TKMPointF; aSpeed,aArc,aMaxLength: Single; aProjType: TProjectileType; aOwner: TKMUnit): Word;
