...
type
  ...
  public
    ...
    procedure SaveToFile(aFileName: UnicodeString; const aInsetRect: TKMRect); overload;
...
procedure TKMTerrainPainter.SaveToFile(aFileName: UnicodeString; const aInsetRect: TKMRect);
var
