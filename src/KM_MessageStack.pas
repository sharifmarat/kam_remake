...
type
  ...
  public
    ...
    constructor Create(aKind: TKMMessageKind; aText: UnicodeString; const aLoc: TKMPoint);
  ...
  public
    ...
    procedure Add(aKind: TKMMessageKind; aText: UnicodeString; const aLoc: TKMPoint);
...
{ TKMStackMessage }
constructor TKMStackMessage.Create(aKind: TKMMessageKind; aText: UnicodeString; const aLoc: TKMPoint);
begin
  inherited Create;
  fKind := aKind;
  fLoc := aLoc;
...
procedure TKMMessageStack.Add(aKind: TKMMessageKind; aText: UnicodeString; const aLoc: TKMPoint);
begin
