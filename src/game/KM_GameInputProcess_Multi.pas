...
procedure TGameInputProcess_Multi.TakeCommand(const aCommand: TGameInputCommand);
var I,Tick: Cardinal;
begin
...
procedure TGameInputProcess_Multi.PlayerTypeChange(aPlayer: TKMHandIndex; aType: TKMHandType);
begin
