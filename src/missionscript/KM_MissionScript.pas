...
type
  ...
  TKMCommandType = (ctUnknown=0,ctSetMap,ctSetMaxPlayer,ctSetCurrPlayer,ctHumanPlayer,ctUserPlayer,ctSetHouse,
                    ctSetTactic,ctAIPlayer,ctAdvancedAIPlayer,ctEnablePlayer,ctSetNewRemap,ctSetMapColor,ctSetRGBColor,ctCenterScreen,ctChooseLoc,ctChooseLocAddWare,ctChooseLocAddUnit,
...
const
  COMMANDVALUES: array [TKMCommandType] of AnsiString = (
    ...
    'SET_MAP_COLOR',
    'SET_RGB_COLOR',
    'CENTER_SCREEN','CHOOSE_LOC','CHOOSE_LOC_ADD_WARE','CHOOSE_LOC_ADD_UNIT','CLEAR_UP','BLOCK_TRADE', 'BLOCK_UNIT','BLOCK_HOUSE','RELEASE_HOUSE',
