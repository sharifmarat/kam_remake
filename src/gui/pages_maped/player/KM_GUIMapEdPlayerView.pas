...
begin
  ...
  TKMLabel.Create(Panel_PlayerView, 0, PAGE_TITLE_Y, TB_WIDTH, 0, gResTexts[TX_MAPED_FOG], fntOutline, taCenter);
  ...
  CheckBox_RevealAll          := TKMCheckBox.Create(Panel_PlayerView, 0, 75, 140, 20, gResTexts[TX_MAPED_FOG_ALL], fntMetal);
  CheckBox_RevealAll.OnClick  := Player_ViewClick;
  TKMLabel.Create(Panel_PlayerView, 0, 100, TB_WIDTH, 0, gResTexts[TX_MAPED_FOG_CENTER], fntOutline, taCenter);
