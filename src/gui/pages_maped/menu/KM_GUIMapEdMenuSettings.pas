...
begin
  ...
  Panel_Settings.Anchors := [anLeft, anTop, anBottom];
    ...
    TrackBar_Settings_Brightness.AnchorsStretch;
    ...
    TrackBar_Settings_ScrollSpeed.AnchorsStretch;
    ...
    TrackBar_Settings_SFX.AnchorsStretch;
    ...
    TrackBar_Settings_Music.AnchorsStretch;
    ...
    CheckBox_Settings_MusicOff.AnchorsStretch;
