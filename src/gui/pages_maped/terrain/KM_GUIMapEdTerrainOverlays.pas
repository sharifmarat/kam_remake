...
begin
  ...
  begin
    OverlaysTable[J] := TKMButtonFlat.Create(Panel_Overlays, 9 + (J mod BTNS_PER_ROW) * BTN_SIZE, BTN_SIZE + (J div BTNS_PER_ROW) * BTN_SIZE, BTN_SIZE, BTN_SIZE, IfThen(MAPED_OVERLAYS_ID[J] > 0, MAPED_OVERLAYS_ID[J] + 1, 0), rxTiles);
