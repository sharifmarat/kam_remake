...
function TKMMenuResultsMP.GetChartWares(aPlayer: TKMHandIndex; aWare: TKMWareType; aUseGDP: Boolean): TKMCardinalArray;
const
...
procedure TKMMenuResultsMP.Show(aMsg: TKMGameResultMsg);
begin
  fGameResultMsg := aMsg;
