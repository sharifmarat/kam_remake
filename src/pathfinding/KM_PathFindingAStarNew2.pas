...
type
  ...
  TPathFindingAStarNew2 = class(TPathFinding)
  private
    fHeap: TBinaryHeap;
    fMinN: PANodeRec;
...
{ TPathFindingAStarNew2 }
constructor TPathFindingAStarNew2.Create;
var
  X, Y: Integer;
begin
  inherited;
...
destructor TPathFindingAStarNew2.Destroy;
begin
  fHeap.Free;
...
function TPathFindingAStarNew2.HeapCmp(A, B: Pointer): Boolean;
begin
  if A = nil then
    Result := True
  else
...
function TPathFindingAStarNew2.MakeRoute: Boolean;
...
procedure TPathFindingAStarNew2.ReturnRoute(NodeList: TKMPointList);
var
  N: PANodeRec;
begin
  NodeList.Clear;
