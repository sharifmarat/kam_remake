...
begin
  ...
  begin
    ...
    ScaleX := Max(0, (Img.Width - 2*OFFSET) / Max(1,Length(fGeneHistory[K,L])-1));
...
begin
  ...
  begin
    ...
    Img.Canvas.Rectangle(X+5, Img.Height - OFFSET, X+10, Img.Height - OFFSET - Round(VarianceArr[K] / MaxVariance * 50));
  end;
end;
